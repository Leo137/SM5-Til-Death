...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=function(self)
		self:xy(18,SCREEN_BOTTOM-225 - 5):visible(true):halign(0):zoom(0.4):maxwidth(capWideScale(get43size(360),360)/capWideScale(get43size(0.45),0.45)):shadowlength(1)
	end,
	SetCommand=function(self)
...
t[#t+1] = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=function(self)
			self:xy(frameX,frameY-76):zoomto(110,94):halign(0):valign(0):diffuse(getMainColor('frames')):diffusealpha(0.9)
		end,
	},
	Def.Quad{
		InitCommand=function(self)
			self:xy(frameX,frameY+18):zoomto(frameWidth+4,50):halign(0):valign(0):diffuse(getMainColor('frames')):diffusealpha(0.9)
		end,
	},
	Def.Quad{
		InitCommand=function(self)
			self:xy(frameX,frameY-76):zoomto(4,144):halign(0):valign(0):diffuse(getMainColor('highlight')):diffusealpha(1.0)
		end,
	},
...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=function(self)
		self:xy(frameX+120 + 30,frameY + 30):halign(0.5):zoom(0.2,maxwidth,60)
	end,
	BeginCommand=function(self)
		self:queuecommand("Set")
	end,
...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=function(self)
		self:xy(frameX+120 + 70 + 30,frameY + 30):halign(0.5):zoom(0.2,maxwidth,60)
	end,
	BeginCommand=function(self)
		self:queuecommand("Set")
	end,
...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=function(self)
		self:xy(frameX+120 + 140 + 30,frameY + 30):halign(0.5):zoom(0.2,maxwidth,60)
	end,
	BeginCommand=function(self)
		self:queuecommand("Set")
	end,
