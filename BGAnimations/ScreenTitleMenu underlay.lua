...
t[#t+1] = Def.Quad{
	InitCommand=function(self)
		self:xy(0,0):halign(0):valign(0):zoomto(250,900):diffuse(color("#161515")):diffusealpha(0)
	end;
};
...
t[#t+1] = Def.Quad{
	InitCommand=function(self)
		self:xy(250,0):halign(0):valign(0):zoomto(1000,900):diffuse(color("#222222")):diffusealpha(0)
	end;
};
