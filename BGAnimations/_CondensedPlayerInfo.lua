...
t[#t+1] = Def.ActorFrame{
  ...
  LoadFont("Common Normal") .. {
    InitCommand=function(self)
      self:xy(SCREEN_CENTER_X-129,AvatarY+30):halign(0.5):zoom(0.35):diffuse(getMainColor('positive'))
    end,
    BeginCommand=function(self)
      self:queuecommand("Set")
    end,
  ...
  LoadFont("Common Normal") .. {
    InitCommand=function(self)
      self:xy(SCREEN_CENTER_X,AvatarY+15):halign(0.5):zoom(0.5):diffuse(getMainColor('positive'))
    end,
    BeginCommand=function(self)
      self:queuecommand("Set")
    end,
  ...
  LoadFont("Common Normal") .. {
    InitCommand=function(self)
      self:xy(SCREEN_WIDTH-240,AvatarY+10):halign(1):zoom(0.35):diffuse(getMainColor('positive'))
    end,
    BeginCommand=function(self)
      self:queuecommand("Set")
    end,
  ...
  LoadFont("Common Normal") .. {
    InitCommand=function(self)
      self:xy(SCREEN_WIDTH-240,AvatarY+20):halign(1):zoom(0.35):diffuse(getMainColor('positive'))
    end,
    BeginCommand=function(self)
      self:queuecommand("Set")
    end,
  ...
  LoadFont("Common Normal") .. {
    InitCommand=function(self)
      self:xy(SCREEN_WIDTH-240,AvatarY+30):halign(1):zoom(0.35):diffuse(getMainColor('positive'))
    end,
    BeginCommand=function(self)
      self:queuecommand("Set")
    end,
